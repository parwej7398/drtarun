...
const Footer = () => {
  ...
  const handleOpenMap = () => {
    window.open("https://maps.app.goo.gl/Mkg5T8QzZZ8qtagYA", "_blank");
  };

  return (
    <footer className="relative bg-gradient-to-br from-gray-900 via-gray-800 to-gray-900 text-white overflow-hidden">
      <div className="absolute inset-0 bg-grid-pattern opacity-5"></div>
      <div className="absolute top-0 right-0 w-96 h-96 bg-gradient-to-br from-amber-500/20 to-orange-500/20 rounded-full blur-3xl opacity-10"></div>
      <div className="absolute bottom-0 left-0 w-96 h-96 bg-gradient-to-tr from-cyan-500/20 to-blue-500/20 rounded-full blur-3xl opacity-10"></div>
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 pt-16 pb-8 relative z-10">
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8 mb-12">
          ...
          <div className="space-y-4">
            ...
            >
              <div className="w-10 h-10 bg-gradient-to-br from-amber-500 to-orange-500 rounded-xl flex items-center justify-center shadow-md group-hover:shadow-lg transition-all duration-300">
                <svg
              ...
              <div>
                <span className="text-xl font-bold bg-gradient-to-r from-white to-gray-300 bg-clip-text text-transparent block leading-tight">
                  Dr. Tarun <span className="text-amber-400">Mittal</span>
                </span>
          ...
          {/* Quick Links - Added Appointment */}
          <div className="space-y-4">
            <h3 className="text-lg font-semibold text-white mb-4 relative inline-block">
              Quick Links
              <div className="absolute bottom-0 left-0 w-12 h-0.5 bg-amber-500 rounded-full mt-1"></div>
            </h3>
            <ul className="space-y-2">
              ...
              <li>
                <Link
                  href="/about-us"
                  className={`text-gray-300 hover:text-amber-400 transition-colors duration-300 flex items-center gap-2 group ${
                    isActive("/about-us") ? "text-amber-400" : ""
                  }`}
                >
                  <span className="w-1 h-1 bg-amber-500 rounded-full group-hover:w-2 transition-all duration-300"></span>
                  About Us
              ...
              <li>
                <Link
                  href="/testimonial"
                  className={`text-gray-300 hover:text-amber-400 transition-colors duration-300 flex items-center gap-2 group ${
                    isActive("/testimonial") ? "text-amber-400" : ""
                  }`}
                >
                  <span className="w-1 h-1 bg-amber-500 rounded-full group-hover:w-2 transition-all duration-300"></span>
                  Testimonials
              ...
              <li>
                <Link
                  href="/appointment"
                  className={`text-gray-300 hover:text-amber-400 transition-colors duration-300 flex items-center gap-2 group ${
                    isActive("/appointment") ? "text-amber-400" : ""
                  }`}
                >
                  <span className="w-1 h-1 bg-amber-500 rounded-full group-hover:w-2 transition-all duration-300"></span>
                  Appointment
          ...
          <div className="space-y-4">
            ...
            <div className="mb-4 p-3 bg-gradient-to-r from-amber-900/50 to-orange-800/50 rounded-xl border border-amber-500/30">
              <p className="text-sm font-semibold text-amber-400 mb-2 flex items-center gap-2">
                <span className="text-lg">🏥</span> OPD Address (Main):
              </p>
              <ul className="space-y-2">
                <li className="flex items-start gap-3 text-gray-300">
                  ...
                  <span className="text-sm font-medium">
                    Life Care Centre, Near Narula Diagnostic Centre, Medical
                    College Mor, Rohtak-124001 (Haryana)
                  </span>
                </li>
              </ul>
            </div>
            ...
            <ul className="space-y-3">
              <li className="flex items-start gap-3 text-gray-300 hover:text-amber-400 transition-colors duration-300">
                <svg
                  className="w-5 h-5 text-amber-400 flex-shrink-0 mt-0.5"
                  fill="none"
                  stroke="currentColor"
                ...
                <a href="tel:9780890425" className="hover:text-amber-400 transition-colors">
                  9780890425
                </a>
              </li>
            </ul>
          ...
          <div className="space-y-4">
            ...
            <div className="bg-white/10 rounded-xl overflow-hidden backdrop-blur-sm shadow-lg">
              ...
              <div className="p-3">
                ...
                <button
                  ...
                  className="w-full bg-gradient-to-r from-amber-500 to-orange-500 text-white px-3 py-2 rounded-lg text-sm font-semibold hover:shadow-lg transition-all duration-300 transform hover:scale-105 flex items-center justify-center gap-2"
                >
                  <svg
                    className="w-4 h-4"
                    fill="none"
            ...
            <div className="mt-2 p-3 bg-white/5 rounded-lg border border-white/10">
              <p className="text-xs font-semibold text-amber-400 mb-2">🕒 Clinic Hours:</p>
              <div className="space-y-2">
                <div className="text-xs text-gray-300">
                  <span className="font-semibold text-emerald-400">Tuesday, Thursday & Saturday:</span>
                  <br />
                  9:00 AM - 2:00 PM & 5:00 PM - 6:00 PM
                </div>
                <div className="text-xs text-gray-300">
                  <span className="font-semibold text-emerald-400">Monday, Wednesday & Friday:</span>
                  <br />
                  5:00 PM - 6:00 PM
                </div>
              </div>
              <p className="text-xs text-amber-400 mt-3">
                📍 Landmark: Near Narula Diagnostic Centre, Medical College Mor, Rohtak
              </p>
